...
from chiptherm.benchmark_v2_pipeline import validate_full_root


def main() -> int:
    parser = argparse.ArgumentParser(description="Strictly validate Benchmark v2 full_50x200.")
