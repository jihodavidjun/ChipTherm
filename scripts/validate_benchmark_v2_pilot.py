...
from chiptherm.benchmark_v2_pipeline import validate_pilot_root


def main() -> int:
    parser = argparse.ArgumentParser(description="Strictly validate the Benchmark v2 5x10 pilot.")
