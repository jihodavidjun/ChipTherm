...
from chiptherm.benchmark_v2_pipeline import relocate_pilot
...
def main() -> int:
    ...
    report = relocate_pilot(args.source_root, args.destination_root, residual_checkpoint=args.residual_checkpoint)
